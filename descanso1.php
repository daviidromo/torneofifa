...
<head>
    ...
    <title>Descanso - Torneo FIFA 26</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="video-container">
        <video class="video-descanso" autoplay muted loop playsinline>
            <source src="descansos/descanso1.mp4" type="video/mp4">
            <source src="img/descanso1.webm" type="video/webm">
    ...
    <div class="overlay">
        <div class="contenido-descanso">
            <h1 class="titulo-descanso">DESCANSO 1</h1>
